...
models_folder_path = os.path.join(here, 'model')  # 模型保存文件夹
...
image_face_path = os.path.join(faces_folder_path, 'yangmi_25.png')  # 人脸图片路径
...
def main():
    ...
    im1 = cv2.resize(im1, (600,im1.shape[0]*600 //im1.shape[1])) #im1.shape[0] * 600 // im1.shape[1]
